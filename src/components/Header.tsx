...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full p-4 flex justify-center animate-in slide-in-from-top-full duration-700 pointer-events-none">
      <div className="glass-panel-strong rounded-full px-6 py-3 flex gap-4 pointer-events-auto floating-element shadow-lg">
