  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 pb-16 flex flex-col items-center relative z-20">
      ...
      <div className="mt-6 flex flex-wrap justify-center gap-3 select-none">
        <span className="px-4 py-1.5 rounded-full bg-white/30 border border-white/50 text-xs sm:text-sm font-semibold text-gray-600 backdrop-blur-md shadow-sm animate-[hover-float_4s_ease-in-out_infinite] will-change-transform">
          NLP-Ready Output
        </span>
        <span className="px-4 py-1.5 rounded-full bg-white/30 border border-white/50 text-xs sm:text-sm font-semibold text-gray-600 backdrop-blur-md shadow-sm animate-[hover-float_4s_ease-in-out_infinite_0.5s] will-change-transform">
          Sentiment Analysis
        </span>
        <span className="px-4 py-1.5 rounded-full bg-white/30 border border-white/50 text-xs sm:text-sm font-semibold text-gray-600 backdrop-blur-md shadow-sm animate-[hover-float_4s_ease-in-out_infinite_1s] will-change-transform">
          Engagement Metrics
        </span>
      </div>
    </div>
