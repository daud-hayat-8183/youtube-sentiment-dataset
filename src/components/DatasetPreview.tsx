...
export default function DatasetPreview() {
  ...
  return (
    <section className="w-full max-w-6xl lg:max-w-5xl mx-auto px-4 py-16 lg:py-24 relative z-20 select-none">
              ...
              <tbody className="divide-y divide-gray-200/60">
                {sampleData.map((row, i) => (
                  <tr key={i} className="hover:bg-white/60 transition-colors text-sm text-gray-900 font-medium group/row">
                    <td className="px-4 py-4 max-w-[150px] sm:max-w-[200px] truncate text-gray-900 group-hover/row:text-blue-900 transition-colors">{row.text}</td>
